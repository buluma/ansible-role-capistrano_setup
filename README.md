# [capistrano_setup](#capistrano_setup)
...
- pip packages listed in [requirements.txt](https://github.com/buluma/ansible-role-capistrano_setup/blob/main/requirements.txt).
